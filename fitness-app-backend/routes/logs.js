...
router.post('/', authenticateToken, async (req, res) => {
    ...
    try {
        ...
        logger.error('Error al procesar log diario:', { error: error.message, stack: error.stack, user_id });
        return res.status(500).json({ error: 'Error interno del servidor al procesar el log.' });
    }
});
...
router.get('/weight/history', authenticateToken, async (req, res) => {
    ...
    try {
        ...
        logger.error('Error al obtener histórico de peso:', { error: error.message, stack: error.stack, user_id });
...
router.get('/:date', authenticateToken, async (req, res) => {
    ...
    try {
        ...
        logger.error('Error al cargar log diario:', { error: error.message, stack: error.stack, user_id, date });
        return res.status(500).json({ error: 'Error interno del servidor.' });
    }
});
