...
const ModernRoutineCard = ({ routine, onDelete }) => {
    ...
    return (
        <Link to={`/routines/${routine.routine_id}`} className="block group">
            <div className="backdrop-blur-xl bg-white/60 dark:bg-black/60 rounded-3xl border border-gray-200/50 dark:border-gray-800/50 p-6 hover:border-gray-300/50 dark:hover:border-gray-700/50 hover:shadow-lg transition-all duration-500 h-full flex flex-col shadow-sm hover:scale-[1.02]">
                {/* Header */}
